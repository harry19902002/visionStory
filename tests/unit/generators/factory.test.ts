...
import { ApiyiImageGenerator } from '@/lib/generators/image'
...
describe('generator factory', () => {
  ...
  it('routes apiyi provider to ApiyiImageGenerator', () => {
    expect(createImageGenerator('apiyi')).toBeInstanceOf(ApiyiImageGenerator)
  })
})
