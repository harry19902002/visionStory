...
export function useNovelPromotionWorkspaceController({
  ...
  const executionState = {
    ...
    voiceAnalyzeConsoleMinimized: execution.voiceAnalyzeConsoleMinimized,
    setVoiceAnalyzeConsoleMinimized: execution.setVoiceAnalyzeConsoleMinimized,
    storyToScriptStream: execution.storyToScriptStream,
    scriptToStoryboardStream: execution.scriptToStoryboardStream,
    voiceAnalyzeStream: execution.voiceAnalyzeStream,
