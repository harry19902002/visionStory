...
import { MINIMAX_SYSTEM_VOICES, MinimaxVoice } from '@/lib/constants/minimax-voices'

interface MinimaxVoicePickerDialogProps {
    isOpen: boolean
    onClose: () => void
...
export default function MinimaxVoicePickerDialog({ isOpen, onClose, onSelect, currentVoiceId }: MinimaxVoicePickerDialogProps) {
    ...
    const allTags = useMemo(() => {
        ...
        MINIMAX_SYSTEM_VOICES.forEach(v => {
    ...
    const filteredVoices = useMemo(() => {
        return MINIMAX_SYSTEM_VOICES.filter(voice => {
    ...
    const handlePlay = (voice: MinimaxVoice, e: React.MouseEvent) => {
        e.stopPropagation()
